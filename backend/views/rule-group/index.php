...
/* @var $searchModel app\models\RuleGroupSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Rule Groups');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="admin_index rule-group-index">
    ...
    <?= GridView::widget([
            ...
            [
                'content' =>
                    Html::a('<i class="fa fa-plus"></i>',['create'], [
                            ...
                            'title' => Yii::t('app', 'Create RuleGroup'),
                    ]) . ' '.
        ...
        'panel' => [
              ...
              'heading' => '<i class="fas fa-cubes"></i>  RuleGroup',
        ],
    ]); ?>
