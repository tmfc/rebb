...
$this->title = Yii::t('app', 'Rule Templates');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="admin_index rule-template-index">
    ...
    <?= GridView::widget([
            ...
            [
                'content' =>
                    Html::a('<i class="fa fa-plus"></i>',['create'], [
                            ...
                            'title' => Yii::t('app', 'Create RuleTemplate'),
                    ]) . ' '.
        ...
        'panel' => [
              ...
              'heading' => '<i class="fas fa-cubes"></i>  RuleTemplate',
        ],
    ]); ?>
