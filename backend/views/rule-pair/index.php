...
/* @var $searchModel app\models\RulePairSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Rule Pairs');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="admin_index rule-pair-index">
...
//            'description',
            ...
            [
                'content' =>
                    Html::a('<i class="fa fa-plus"></i>',['create'], [
                            ...
                            'title' => Yii::t('app', 'Create RulePair'),
                    ]) . ' '.
        ...
        'panel' => [
              ...
              'heading' => '<i class="fas fa-cubes"></i>  RulePair',
        ],
    ]); ?>
